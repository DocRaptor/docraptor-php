...
class DocApi
{
     ...
     *
     * @param  object $id The download_id returned from status request or a callback. (required)
     *
     * @throws \DocRaptor\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return string
     ...
     *
     * @param  object $id The status_id returned when creating an asynchronous document. (required)
     *
     * @throws \DocRaptor\ApiException on non-2xx response
     * @throws \InvalidArgumentException
